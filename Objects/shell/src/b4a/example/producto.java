...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"Existencia",_ref.getField(false, "_existencia"),"Id",_ref.getField(false, "_id"),"IVA",_ref.getField(false, "_iva"),"Nombre",_ref.getField(false, "_nombre"),"PrecioUnitario",_ref.getField(false, "_preciounitario")};
}
}